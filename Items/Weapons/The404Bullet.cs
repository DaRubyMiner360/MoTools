...
{
	public class The404Bullet : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("404 Bullet");
		...
		public override void SetDefaults() {
			...
			item.value = 10;
			item.rare = 2;
			item.shoot = ProjectileType<Projectiles.Ranged.The404Bullet>();   //The projectile shoot when your weapon using this ammo
