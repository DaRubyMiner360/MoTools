...
{
    public class UnlimitedPaperBullets : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Unlimited Paper Balls");
        ...
        public override void SetDefaults()
        {
            ...
            item.value = 1000;
            item.rare = 8;
            item.shoot = mod.ProjectileType("PaperBullet");
            item.shootSpeed = 9f;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.ItemType("PaperBullet"), 3996);
            ...
            recipe.AddIngredient(mod.ItemType("PaperBullet"), 1);
            recipe.SetResult(this);
            recipe.AddRecipe();
        }
        /*
