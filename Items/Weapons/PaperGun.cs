...
namespace MoTools.Items.Weapons
{
	public class PaperGun : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("It's a gun made of paper!");
		}
		...
		/*public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			type = Main.rand.Next(new int[] { type, ProjectileType<Projectiles.PaperBullet>(), ProjectileType<Projectiles.PaperBullet2>() });
			return true;
		}*/
	}
}
