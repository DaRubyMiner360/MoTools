...
{
	public class QuasarShotgun : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Quasar Shotgun");
			Tooltip.SetDefault("The shotgun made of White Celestial Shards.");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(mod, "WhiteCelestialShard", 25);
