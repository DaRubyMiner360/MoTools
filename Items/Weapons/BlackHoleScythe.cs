...
{
	public class BlackHoleScythe : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("The scythe made of black holes and a celestial blade.");  //The (English) text shown below your weapon's name
		}

		public override void SetDefaults() {
			item.damage = 304;           //The damage of your weapon
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(mod, "BlackCelestialShard", 50);
