...
{
	internal class The404HookItem : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("404 Infused Hook");
		}
		...
		public override void SetDefaults() {
			...
			*/
			...
			item.CloneDefaults(ItemID.Amethyst);
			item.shootSpeed = 30f; // how quickly the hook is shot.
			item.shoot = ProjectileType<The404HookProjectile>();
		}
	}

	internal class The404HookProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		public override bool? CanUseGrapple(Player player) {
			...
			if (hooksOut > 9) // This hook can have 10 hooks out.
			{
				return false;
			}
			return true;
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor) {
			...
			while (distance > 30f && !float.IsNaN(distance)) {
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/The404HookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
