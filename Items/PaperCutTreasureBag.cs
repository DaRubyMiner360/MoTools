...
{
    public class PaperCutTreasureBag : ModItem
    {
        ...
        {
            player.QuickSpawnItem(ModContent.ItemType<Items.Paper>(), Main.rand.Next(20, 35));
        ...
        public override int BossBagNPC => ModContent.NPCType<PaperCut>();
    }
}