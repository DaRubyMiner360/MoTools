...
{
	public class Mundane : MythicDamageItem
	{
		...
		public static void AddHacks()
		{
			...
			// to benefit from ranged bonuses, despite being an Mythic damage weapon.
		...
		// Our MythicDamageItem abstract class handles all code related to our custom damage class
		public override void SafeSetDefaults()
		{
			item.CloneDefaults(ItemID.HellwingBow);
