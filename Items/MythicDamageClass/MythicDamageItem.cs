...
namespace MoTools.Items.MythicDamageClass
{
	...
	public abstract class MythicDamageItem : ModItem
	{
		public override bool CloneNewInstances => true;
		public int mythicResourceCost = 0;
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips) {
			...
			if (tt != null) {
				...
				tt.text = damageValue + " mythic " + damageWord;
			}

			if(mythicResourceCost > 0) {
				tooltips.Add(new TooltipLine(mod, "Mythic Resource Cost", $"Uses {mythicResourceCost} mythic resource"));
			}
		}

		// Make sure you can't use the item if you don't have enough resource and then use 10 resource otherwise.
		public override bool CanUseItem(Player player) {
			var mythicDamagePlayer = player.GetModPlayer<MythicDamagePlayer>();

			if (mythicDamagePlayer.mythicResourceCurrent >= mythicResourceCost) {
				mythicDamagePlayer.mythicResourceCurrent -= mythicResourceCost;
				return true;
			}
			return false;
		}
