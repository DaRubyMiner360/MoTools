...
{
	public class RainbowCelestialShard : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("A shard of the White, Black, Purple, Yellow, and Blue Celestials.\nA shard of the RAINBOW CELESTIAL!");
