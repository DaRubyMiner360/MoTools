...
{
	public class ConsumeAmmoDisruptor : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Ammo Consuming Disruptor");
			Tooltip.SetDefault("Never consume ammo!");
		}
		...
		public override void UpdateAccessory(Player player, bool hideVisual) {
			player.GetModPlayer<MoToolsPlayer>().consumeAmmoDisruption = true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(mod, "The404Arrow", 999);
			recipe.AddIngredient(mod, "The404Arrow2", 999);
			recipe.AddIngredient(mod, "The404Bullet", 999);
			recipe.AddIngredient(mod, "The404Bullet2", 999);
			recipe.AddIngredient(mod, "The404Arrow", 999);
			recipe.AddIngredient(mod, "The404Arrow2", 999);
			recipe.AddIngredient(mod, "The404Bullet", 999);
			recipe.AddIngredient(mod, "The404Bullet2", 999);
	...
	public class ConsumeAmmoDisruptorGlobalItem : GlobalItem
	{
		public override bool ConsumeAmmo(Item item, Player player) {
			return !player.GetModPlayer<MoToolsPlayer>().consumeAmmoDisruption;
		}
	}
}
