...
{
	public class LoseHealthDisruptor : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Health Losing Disruptor");
			Tooltip.SetDefault("Never lose health!");
		}
		...
		public override void UpdateAccessory(Player player, bool hideVisual) {
			player.GetModPlayer<MoToolsPlayer>().loseHealthDisruption = true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ItemID.LifeCrystal, 999);
	...
	public class LoseHealthDisruptorGlobalItem : GlobalItem
	{
