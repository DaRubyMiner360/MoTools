...
{
	public class ConsumeItemDisruptor : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Item Consuming Disruptor");
			Tooltip.SetDefault("Never consume items!");
		}
		...
		public override void UpdateAccessory(Player player, bool hideVisual) {
			player.GetModPlayer<MoToolsPlayer>().consumeItemDisruption = true;
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(mod, "The404Essence", 200);
			recipe.AddIngredient(mod, "The404Ore", 100);
	...
	public class ConsumeItemDisruptorGlobalItem : GlobalItem
	{
		public override bool ConsumeItem(Item item, Player player) {
			return !player.GetModPlayer<MoToolsPlayer>().consumeItemDisruption;
		}
	}
}
