...
{
	public class The404Clay : ModItem
	{
		public override void SetStaticDefaults() {
			//Tooltip.SetDefault("This is a modded clay block.");
			DisplayName.SetDefault("404 Clay");
		}
		...
		public override void SetDefaults() {
			...
			item.createTile = ModContent.TileType<Tiles.The404Clay>();
