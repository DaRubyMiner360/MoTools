...
{
	public class The404Dirt : ModItem
	{
		public override void SetStaticDefaults() {
			//Tooltip.SetDefault("This is a modded dirt block.");
			DisplayName.SetDefault("404 Dirt");
		}
		...
		public override void SetDefaults() {
			...
			item.createTile = ModContent.TileType<Tiles.The404Dirt>();
