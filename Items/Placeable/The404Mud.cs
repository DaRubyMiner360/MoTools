...
{
	public class The404Mud : ModItem
	{
		public override void SetStaticDefaults() {
			//Tooltip.SetDefault("This is a modded mud block.");
			DisplayName.SetDefault("404 Mud");
		}
		...
		public override void SetDefaults() {
			...
			item.createTile = ModContent.TileType<Tiles.The404Mud>();
