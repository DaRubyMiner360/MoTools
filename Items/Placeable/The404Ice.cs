...
{
	public class The404Ice : ModItem
	{
		public override void SetStaticDefaults() {
			//Tooltip.SetDefault("This is a modded ice block.");
			DisplayName.SetDefault("404 Ice");
		}
		...
		public override void SetDefaults() {
			...
			item.createTile = ModContent.TileType<Tiles.The404Ice>();
