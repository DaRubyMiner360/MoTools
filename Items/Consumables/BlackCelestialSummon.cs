...
{
	public class BlackCelestialSummon : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Black Celestial");
			Tooltip.SetDefault("The wrath of the black sky");
		...
		public override bool UseItem(Player player) {
			NPC.SpawnOnPlayer(player.whoAmI, NPCType<BlackCelestial>());
			NPC.SpawnOnPlayer(player.whoAmI, NPCType<BlackCelestial>());
			NPC.SpawnOnPlayer(player.whoAmI, NPCType<BlackCelestial>());
			NPC.SpawnOnPlayer(player.whoAmI, NPCType<BlackCelestial>());
			NPC.SpawnOnPlayer(player.whoAmI, NPCType<BlackCelestial>());
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(mod, "BlackCelestialShard", 999);
