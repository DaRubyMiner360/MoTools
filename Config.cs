...
namespace MoTools
{
	...
	public class ConfigServer : ModConfig
	{
		...
		[Tooltip("Prevents The Rainbow Celestial From Dropping 404 Essence.")]
		public bool RainbowCelestialDrops404Essence { get; set; }

		[ReloadRequired]
		[Label("Disable Give Command")]
		[Tooltip("Prevents Using The Give Command.")]
		public bool DisableGiveCommand { get; set; }

		[ReloadRequired]
		[Label("Disable Summon Command")]
		[Tooltip("Prevents Using The Summon Command.")]
		public bool DisableSummonCommand { get; set; }

		[ReloadRequired]
		[Label("Disable NpcID Command")]
		[Tooltip("Prevents Using The NpcID Command.")]
		...
		[ReloadRequired]
		[Label("Disable Weather Command")]
		[Tooltip("Prevents Using The Weather Command.")]
		public bool DisableWeatherCommand { get; set; }

		[ReloadRequired]
		[Label("Disable Butcher Command")]
		[Tooltip("Prevents Using The Butcher Command.")]
		public bool DisableButcherCommand { get; set; }
		...
		// [Tooltip("Prevents Using The Give Command. Requires a Reload")]
		// [Tooltip("Prevents Using The Give Command.")]
	...
	public class TweaksConfig : ModConfig
	{
		// You MUST specify a ConfigScope.
		public override ConfigScope Mode => ConfigScope.ServerSide;
		...
		[Label("The Annihilator HP")]
		[Tooltip("Sets The Annihilator's HP.")]
		public int TheAnnihilatorHP { get; set; }
