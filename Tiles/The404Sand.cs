...
{
	public class The404Sand : ModTile
	{
		//Note: The404Sand requires The404SandProjectile to work.
		...
		//The404Sand (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			//Drop the The404SandBlock
			drop = ModContent.ItemType<Items.Placeable.The404Sand>();
