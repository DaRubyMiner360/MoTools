...
{
	public class The404Sandstone : ModTile
	{
		//The404Sandstone (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			TileID.Sets.Conversion.Sandstone[Type] = true; // Allows Clentaminator solutions to convert this tile to their respective Sand tiles.
			...
			//Drop the The404SandstoneBlock
			drop = ModContent.ItemType<Items.Placeable.The404Sandstone>();
