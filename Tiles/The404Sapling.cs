...
{
	public class The404Sapling : ModTile
	{
		public override void SetDefaults() {
			...
			TileObjectData.newTile.AnchorValidTiles = new[] { TileType<The404Block>() };
			...
			TileObjectData.newSubTile.AnchorValidTiles = new int[] { TileType<The404Sand>() };
			TileObjectData.addSubTile(1);
			TileObjectData.addTile(Type);

			ModTranslation name = CreateMapEntryName();
			name.SetDefault("404 Sapling");
