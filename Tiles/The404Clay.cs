...
{
	public class The404Clay : ModTile
	{
		//The404Clay (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			TileID.Sets.Conversion.Grass[Type] = true; // Allows Clentaminator solutions to convert this tile to their respective Sand tiles.
			AddMapEntry(new Color(200, 200, 200));
			//Set the dust type to Sparkle
			dustType = ModContent.DustType<Sparkle>();
			//Drop the The404ClayBlock
			drop = ModContent.ItemType<Items.Placeable.The404Clay>();
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				// Set the projectile type to The404ClayProjectile
