...
{
	public class The404Ice : ModTile
	{
		//The404Ice (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			//Drop the The404IceBlock
			drop = ModContent.ItemType<Items.Placeable.The404Ice>();
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				// Set the projectile type to The404IceProjectile
