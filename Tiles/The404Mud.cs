...
{
	public class The404Mud : ModTile
	{
		//The404Mud (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			//Drop the The404MudBlock
			drop = ModContent.ItemType<Items.Placeable.The404Mud>();
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				// Set the projectile type to The404MudProjectile
