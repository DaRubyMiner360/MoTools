...
{
	public class The404Dirt : ModTile
	{
		//The404Dirt (the item) is just used for placing the tile, this isn't needed and can be placed in other ways
		...
		public override void SetDefaults() {
			...
			//Drop the The404DirtBlock
			drop = ModContent.ItemType<Items.Placeable.The404Dirt>();
		...
		public override bool TileFrame(int i, int j, ref bool resetFrame, ref bool noBreak) {
			...
			if (canFall) {
				// Set the projectile type to The404DirtProjectile
