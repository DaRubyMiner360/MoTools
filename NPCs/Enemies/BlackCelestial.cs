...
{
	public class BlackCelestial : Hover
	{
		public BlackCelestial() {
			speedY = 1f;
			accelerationY = 0.1f;
		}
		...
		public override void SetDefaults() {
			...
			banner = npc.type;
			bannerItem = ItemType<BlackCelestialBanner>();
		}
		...
		{
			Item.NewItem(npc.getRect(), mod.ItemType("BlackCelestialShard"), Main.rand.Next(15, 18));
