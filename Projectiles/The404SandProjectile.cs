...
{
	public class The404SandProjectile : ModProjectile
	{
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("404 Infused Sand Ball");
		...
		public override void SetDefaults() {
			...
			//Set the tile type to The404Sand
			tileType = ModContent.TileType<The404Sand>();
