...
{
	public class The404LastPrismHoldout : ModProjectile
	{
		...
		private void FireBeams()
		{
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(projectile.Center, beamVelocity, ProjectileType<The404LastPrismBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = The404LastPrism.OverrideColor;
